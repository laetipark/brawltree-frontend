...
export const BrawlerStats = ({ brawler, stats, maps }) => {
  ...
  const filterBrawler = maps.filter(({ brawlerID }) => brawlerID === brawler.id).slice(0, 10);
  ...
  return (
    <div className={styles.brawlerStatsWrapper}>
      <div className={styles.brawlerStatsSummaryBox}>
        <div>
          <div>
            <img src={`${config.assets}/modes/icon/trophy.webp`} alt={'트로피'} />
            <div>
              <div className={styles.brawlerRateTitle}>{locales.brawler['stats'].trophyLeaguePick}</div>
          ...
          <div>
            <img src={`${config.assets}/modes/icon/trophy.webp`} alt={'트로피'} />
            <div>
              <div className={styles.brawlerRateTitle}>{locales.brawler['stats'].trophyLeagueWin}</div>
              <div className={styles.brawlerRateContent}>
          ...
          <div>
            ...
            <div>
              <div className={styles.brawlerRateTitle}>{locales.brawler['stats'].powerLeaguePick}</div>
              <div className={styles.brawlerRateContent}>
          ...
          <div>
            <img src={`${config.assets}/modes/icon/powerLeague.webp`} alt={'powerLeague'} />
            <div>
              <div className={styles.brawlerRateTitle}>{locales.brawler['stats'].powerLeagueWin}</div>
              <div className={styles.brawlerRateContent}>
      ...
      <div className={styles.statsSummaryWrapper}>
        {filterBrawler.map(({ mapID, mapName, mode, pickRate, victoryRate }) => {
          return (
            <a key={mapID} className={styles.statsSummaryMapButton} href={`../maps/${mapID}`}>
              <img src={`${config.assets}/modes/icon/${mode}.webp`} alt={mode} />
              <span>{locales.map['map'][`${mapID}`] || mapName}</span>
              <div>
                <span>Pick</span>
                <span>{pickRate}</span>
                <span>%</span>
